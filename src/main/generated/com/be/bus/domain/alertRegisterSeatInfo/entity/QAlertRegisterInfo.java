...
public class QAlertRegisterInfo extends EntityPathBase<AlertRegisterInfo> {
    ...
    public final DateTimePath<java.time.LocalDateTime> lastAlertDateTime = createDateTime("lastAlertDateTime", java.time.LocalDateTime.class);

    public final com.be.bus.domain.operation.entity.QOperation operation;

    public final StringPath seatAlertType = createString("seatAlertType");
